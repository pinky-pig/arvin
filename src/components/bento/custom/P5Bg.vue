...
<template>
  <div>
    ...
    <div
      class="pointer-events-auto absolute left-1/2 top-1/2 z99 h-16 w-16 cursor-pointer rounded-md text-white transition-colors duration-300 ease-in-out -translate-1/2 !select-none hover:bg-[#FFFFFF30]"
      @click="handelRedraw()"
    >
